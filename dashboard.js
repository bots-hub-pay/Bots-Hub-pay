document.addEventListener('DOMContentLoaded', function() {
    ...
    // Check if user is new and hasn't set PIN
    ...
    window.showDashboardSection = function(section) {
        ...
        document.getElementById('addFundSection').style.display = 'none';
        document.getElementById('withdrawSection').style.display = 'none';
        document.getElementById('payUserSection').style.display = 'none';
...
function displayUserInfo(user) {
    ...
    if (nameDisplay) nameDisplay.textContent = user.fullName || 'User';
    if (initialsDisplay) {
